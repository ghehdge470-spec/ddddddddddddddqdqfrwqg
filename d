...
task.spawn(function()
    ...
    loadGui.Name = "ZinxLoadScreen"
    loadGui.ResetOnSpawn = false
    loadGui.DisplayOrder = 9999
    loadGui.Parent = PlayerGui

    -- Splash container (no full black bg)
    local splash = Instance.new("Frame", loadGui)
    splash.Size = UDim2.new(0, 0, 0, 0)
    splash.Position = UDim2.new(0.5, -180, 0.5, -55)
    splash.BackgroundColor3 = Color3.fromRGB(8, 8, 16)
    splash.BackgroundTransparency = 0.1
    splash.BorderSizePixel = 0
    Instance.new("UICorner", splash).CornerRadius = UDim.new(0, 28)
    ...
    title.TextSize = 100000
    title.TextColor3 = Color3.fromRGB(255, 255, 255)
    title.TextStrokeTransparency = 0
    title.TextStrokeColor3 = Color3.fromRGB(0, 120, 255)
    ...
    local sound = Instance.new("Sound", splash)
    sound.SoundId = "rbxassetid://8306999137"
    sound.Volume = 0.5
    sound:Play()
    ...
    TweenService:Create(splash, fadeOut, {BackgroundTransparency = 1}):Play()
...
end        Workspace.DescendantAdded:Connect(function(obj)
...
if Config.FPSBoost then task.spawn(function() 
    task.wait(5)
    Lighting.GlobalShadows = false
    Lighting.FogEnd = 1000000
    Lighting.FogStart = 0
...
sFrame.Size = UDim2.new(0, 420, 0, 450)
sFrame.Position = UDim2.new(Config.Positions.Settings.X, 0, Config.Positions.Settings.Y, 0)
sFrame.BackgroundColor3 = Color3.fromRGB(5, 5, 8); sFrame.BackgroundTransparency = 0
...
sList.Size = UDim2.new(1,-20,1,-50)
sList.ScrollBarThickness = 3; sList.Position = UDim2.new(0,10,0,45)
...
local rDesync = CreateRow("Desync on Steal")
CreateToggleSwitch(rDesync, Config.DesyncOnSteal, function(ns, set)
...
task.spawn(function()
    ...
    main.Position = UDim2.new(0.5, 0, 1, -120)
    ...
    if privateBuild then
        ...
        author.Text = "discord.gg/zinxhub"
    end
